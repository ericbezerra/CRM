...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		...
		<header class="main-header"> <!-- Logo --> <a
			href="enter" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
		...
		<div class="navbar-custom-menu">
			<ul class="nav navbar-nav">
				...
				<li class="dropdown user user-menu">
					<!-- Menu Toggle Button --> <a href="#" class="dropdown-toggle"
					data-toggle="dropdown"> <!-- The user image in the navbar--> <p></p> <!-- hidden-xs hides the username on small devices so only the image appears. -->
					...
					<ul class="dropdown-menu">
						...
						<li class="user-header">
							<p>
								Eric Bezerra - Administrador<small>Membro desde
									Fev. 2013</small>
							</p></li>
						<!-- Menu Body -->
						<li class="user-body">
		...
		<div class="content-wrapper">
			...
			<h1>
				Cabeçalho <small>da pagina</small>
			</h1>
			</section>
		...
		<!-- Default to the left --> <strong>Copyright &copy; 2016 <a
			href="#">Wancorp</a>.
		</strong> Todos diretos reservados. </footer>
